...
from kiteconnectapp.serializers import HistoryDataSerializer, FileSerializer, StockSerializer, PortfolioSerializer
...
from core.models import my_stocks, portfolio, User
...
def handle_uploaded_file_err(df, user, portfolio_name):
    ...
    return str(len(data)-t) + " enteries valid. | " +  str(t) + " enteries inavlid: " + str(err)
...
def upload(request):
    ...
    data =pd.read_excel('/home/akkey/Desktop/Sabertooth/kiteconnectpro/kiteconnectapp/NSE_data.xlsx')
